...
urlpatterns = [
    ...
    path(
        'kanal/<int:channel_id>/wiadomosc-media/',
        views.channel_message_media_upload,
        name='channel_media_upload',
    ),
    ...
    path(
        'dm/<int:user_id>/wiadomosc-media/',
        views.dm_message_media_upload,
        name='dm_media_upload',
    ),
    ...
    path(
        'uzytkownik/<int:user_id>/zglos/',
        views.report_user,
        name='report_user',
    ),
    path('panel/zgloszenia/', views.admin_user_reports, name='admin_user_reports'),
    path(
